...
@section('content')
    <section class="home-banner-area" style="background-image: url({{ asset('images/study.jpg') }})">
        <div class="container-lg">
            <div class="row">
                <div class="col">
                    <div class="home-banner-wrap">
                        <h2>Learn from the best</h2>
                        <p>Enjoy high-Quality Teaching</p>
                            ...
                            <div class="course-box-wrap">
                                ...
                                <div class="webui-popover-content">
                                    <div class="course-popover-content">
                                        ...
                                        <input type="hidden" value="{{ $top_course->id }}" name="course_id">
                                        <input type="hidden" value="{{ $top_course->title }}" name="name">
                                        <input type="hidden" value="{{ $top_course->price }}" name="price">
                                        <input type="hidden" value="1" name="quantity">

                                        <button class="btn btn-add-cart" type="submit" id="{{ $top_course->id }}">Add to
                                            cart
                                        </button>
                                    </form>
                                                <!-- <button type="button"
